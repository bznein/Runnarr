    ...
    <div className="app-shell">
      ...
      <main className="main">
        ...
        <Routes>
          ...
          <Route path="/settings" element={<SettingsPage defaultExperience={preferences?.defaultExperience ?? "full"} onDefaultExperienceChange={onDefaultExperienceChange} themePreference={themePreference} onThemePreferenceChange={onThemePreferenceChange} themePreferenceError={themePreferenceError} />} />
